...
--
-- Host: 127.0.0.1
-- Creato il: Mag 11, 2023 alle 23:38
...
(7, 'ottimo prodotto', 4, 1, 2),
(9, 'ottimo prodotto', 1, 1, 3),
(10, 'ottimo prodotto', 5, 1, 3);
...
(1, 'admin', 'admin', 'admin@admin.com', 'password', 'admin', 1),
(3, 'matteo', 'crippa', '', 'Bassotto23', 'via Spinola 7, Cantù CO, 22063', 0);
...
--
ALTER TABLE `categoria`
  MODIFY `idc` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `foto`
  MODIFY `idf` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
