...
--
-- Host: 127.0.0.1
-- Creato il: Mag 12, 2023 alle 11:18
...
INSERT INTO `commento` (`idcom`, `text`, `stelle`, `IdUtente`, `IdProdotto`) VALUES
(1, 'ottimo prodotto', 1, 1, 3),
(2, 'gg', 1, 1, 3),
(3, 'gg', 3, 1, 3),
(4, 'ciao', 5, 1, 2);
...
(1, 'admin', 'admin', 'admin@email.com', 'password', 'admin1', 1);
...
--
ALTER TABLE `categoria`
  MODIFY `idc` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT per la tabella `commento`
--
ALTER TABLE `commento`
  MODIFY `idcom` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
